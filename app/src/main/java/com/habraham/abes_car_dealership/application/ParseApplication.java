package com.habraham.abes_car_dealership.application;
...
public class ParseApplication extends Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(new Parse.Configuration.Builder(this)
                ...
                .server("https://abes-community-car-dealership.herokuapp.com/parse/").build());

        // Simple test to make sure parse is connected
